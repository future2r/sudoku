...
public final class Column<T> {
	...
	static <T> Column<T> of(final Grid<T> grid, final int columnIndex) {
	...
	private Column(final Grid<T> grid, final int columnIndex) {
	 ...
	 */
	public void set(int rowIndex, T newValue){
